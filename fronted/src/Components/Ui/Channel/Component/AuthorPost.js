        ...
        <div className="post-item" key={post.id}>
          <Paper className="post-paper">
            ...
            <div className="post-footer">
              ...
              {userau===post.beongsto.id ?deleteuserpost(post.beongsto.id) && <div className="delete-icon"><DeleteIcon color="error" onClick={() => handleDelete(post.id)} /></div> : null}
            </div>
          </Paper>
        </div>
      ))}
